...
from .params_model import residual_channels, residual_blocks, se_ratio, seq_input_channels, model_embedding_size
...
class Encoder(nn.Module):
    ...
    def __init__(self, loss_device):
        ...
        # Network defition
        self.transformer = ViT(input_dim=seq_input_channels,
